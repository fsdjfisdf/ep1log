...
// 호버 설명
const descriptions = {
  'MEMBERS': 'NANSI의 멤버들을 확인할 수 있어요.',
  'SCHEDULE': '다가오는 공연 일정을 확인하세요.',
  'RESERVATION': '공연에 참여하고 싶다면 여기서 예약하세요.',
  'FAN BOARD': '저희에게 해주고 싶은 말들을 남겨주세요.',
  'GOODS STORE': '저희가 자체 제작한 굿즈를 확인해보세요.'
};
